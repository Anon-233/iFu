...
trait MicroOpCode {
    ...
    val uopLLW          = 42.U(UOPC_SZ)
    val uopSCW          = 43.U(UOPC_SZ)
    val uopSYSCALL      = 44.U(UOPC_SZ)
    val uopBREAK        = 45.U(UOPC_SZ)
    val uopCSRRD        = 46.U(UOPC_SZ)
    val uopCSRWR        = 47.U(UOPC_SZ)
    val uopCSRXCHG      = 48.U(UOPC_SZ)
    val uopERTN         = 49.U(UOPC_SZ)
    val uopRDCNTIDW     = 50.U(UOPC_SZ)
    val uopRDCNTVLW     = 51.U(UOPC_SZ)
    val uopRDCNTVHW     = 52.U(UOPC_SZ)
    val uopIDLE         = 53.U(UOPC_SZ)
    val uopTLBSRCH      = 54.U(UOPC_SZ)
    val uopTLBRD        = 55.U(UOPC_SZ)
    val uopTLBWR        = 56.U(UOPC_SZ)
    val uopTLBFILL      = 57.U(UOPC_SZ)
    val uopINVTLB       = 58.U(UOPC_SZ)
    val uopCACOP        = 59.U(UOPC_SZ)
    val uopPRELD        = 60.U(UOPC_SZ)
    val uopDBAR         = 61.U(UOPC_SZ)
    val uopIBAR         = 62.U(UOPC_SZ)

    val uopLD           = 63.U(UOPC_SZ)
    val uopSTA          = 64.U(UOPC_SZ)
    val uopSTD          = 65.U(UOPC_SZ)
}