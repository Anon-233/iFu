...
object XDecode extends DecodeConstants with MicroOpCode
{
        ...
        val table: Array[(BitPat, List[BitPat])] = Array(//       |       |       |      |     |  |  |  |  |    |     |   |  |  |  |  |  |
           ...
           PCADDU12I-> List(Y, uopPCADDU12I , IQT_INT, FU_ALU ,RT_FIX, RT_X  , RT_X  , immU20, N, N, N, N, N, M_X  , 1.U, Y, N, N, N, N, CSR.N),
            PCADDI  -> List(Y, uopPCADDI    , IQT_INT, FU_ALU ,RT_FIX, RT_X  , RT_X  , immS20, N, N, N, N, N, M_X  , 1.U, Y, N, N, N, N, CSR.N),
