...
class RegisterFileReadPortIO(val addrWidth: Int, val dataWidth: Int)extends CoreBundle
{
    val addr = Input(UInt(addrWidth.W))
    val data = Output(UInt(dataWidth.W))
}

class RegisterFileWritePort(val addrWidth: Int, val dataWidth: Int)extends CoreBundle
{
